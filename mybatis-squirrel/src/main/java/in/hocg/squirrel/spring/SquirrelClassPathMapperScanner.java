 ...
 */
@Slf4j
public class SquirrelClassPathMapperScanner extends ClassPathBeanDefinitionScanner {
    ...
    public SquirrelClassPathMapperScanner(BeanDefinitionRegistry registry) {
    ...
    private void processBeanDefinitions(Set<BeanDefinitionHolder> beanDefinitions) {
        ...
        for (BeanDefinitionHolder holder : beanDefinitions) {
            ...
            definition.getPropertyValues().add("mappedStatementSupport", this.mappedStatementSupport);
